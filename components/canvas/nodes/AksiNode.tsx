...
export function AksiNode({ id, data }: NodeProps<Node<LifeFlowNodeData>>) {
  ...
  return (
    ...
    >
      ...
      <input
        className="nodrag mt-0.5 w-full bg-transparent font-sans text-sm font-medium text-ink outline-none placeholder:text-ink-soft"
        value={data.label ?? ''}
      ...
      <div className="mt-2 flex items-center gap-2">
        ...
        <input
          ...
          max={3}
          step={1}
          className="nodrag h-3 flex-1 accent-ink"
